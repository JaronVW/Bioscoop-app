...
public class MovieManager {
    ...
    public List<Movie> ratingFilter(List<Movie> movies, String rating) {
        return movies.stream().filter(p -> p.getVoteAverage().toString().equals(rating)).collect(Collectors.toList());
    }
